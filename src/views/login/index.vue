<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-button :loading="loading" type="plain" style="width:100%;margin-bottom:30px; background-color: transparent; color: white" @click.native.prevent="handleLogin('loginForm')">Login</el-button>
