  ...
  >
    ...
    <el-form ref="form" :model="form" label-width="120px">
      ...
      <el-form-item label="接单最小金额">
        <el-input v-model="form.range_from" :disabled="form.level == 'LV0'"></el-input>
      </el-form-item>
      <el-form-item label="接单最大金额">
        <el-input v-model="form.range_to" :disabled="form.level == 'LV5'"></el-input>
      </el-form-item>
